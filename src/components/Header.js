...
const Header = () => {
  return (
    <div className="bg-white rounded-full flex flex-wrap items-center justify-between px-6 py-1 sm:px-12 sm:py-1 mx-4 sm:mx-20 lg:mx-44 shadow-lg">
      ...
      <div className="text-orange-700 text-sm sm:text-2xl sm:font-bold sm:tracking-tighter sm:text-left sm:ml-2 sm:w-[600px]">
        || Bhakti Safar ||
      </div>
      ...
      <div className="flex flex-wrap items-center justify-center gap-6 mr-3 sm:mr-12 sm:gap-12">
        ...
        <a href="tel:+918439377579" className="flex items-center">
          <i
            className="fa-solid fa-phone text-2xl sm:text-3xl"
            style={{ color: "#c2410c" }}
          ></i>
        ...
        >
          <i
            className="fa-solid fa-envelope text-2xl sm:text-3xl"
            style={{ color: "#c2410c" }}
          ></i>
